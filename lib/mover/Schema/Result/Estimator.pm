...
#    return    
    my $full_name = 
    ( defined $self->prefix ) ? $self->prefix . ' ' . $self->first_name . ' ' . $self->last_name :
    $self->first_name . ' ' . $self->last_name;
     return   (defined $self->suffix  ? $full_name . ' ' . $self->suffix :
                $full_name);
}
...
#    return    
    my $full_name = 
    ( defined $self->prefix ) ? ucfirst $self->prefix . ' ' . ucfirst $self->first_name . ' ' . ucfirst $self->last_name :
    ucfirst $self->first_name . ' ' . ucfirst $self->last_name;
     return   (defined $self->suffix  ? $full_name . ' ' . ucfirst $self->suffix :
                $full_name);
}
